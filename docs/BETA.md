> **vr443.1 (2026-09-20):** Point fix after vr443 HOLD. Motion KEEP was not baked into the vr443 binary (batlines only). Grab [vr443.1](https://github.com/no6969el/GEVR/releases/tag/vr443.1) or use Update.
...
**Play this cut:** [**vr443.1**](https://github.com/no6969el/GEVR/releases/latest) (GitHub Latest). Zip: **`GEVR-Beta-vr443.1-win64.zip`**. Play steps: [README](../README.md#play-vr4431---the-one-to-grab). Tag: [vr443.1](https://github.com/no6969el/GEVR/releases/tag/vr443.1).

Older tag **pages** stay for history. **Latest is vr443.1.** Do not download from [vr420](https://github.com/no6969el/GEVR/releases/tag/vr420) / [vr434](https://github.com/no6969el/GEVR/releases/tag/vr434) / [vr438](https://github.com/no6969el/GEVR/releases/tag/vr438) / [vr439](https://github.com/no6969el/GEVR/releases/tag/vr439) / [vr440](https://github.com/no6969el/GEVR/releases/tag/vr440) / [vr441](https://github.com/no6969el/GEVR/releases/tag/vr441).

- **vr434** was pulled. ROM images were baked into `goldeneye.exe`.
- **vr443** zip was pulled (HOLD) then superseded by vr443.1 (motion KEEP not baked in).
...
- Download: [**GEVR-Beta-vr443.1-win64.zip**](https://github.com/no6969el/GEVR/releases/latest) - play steps in [README](../README.md#play-vr4431---the-one-to-grab)
...
1. Download and unzip **`GEVR-Beta-vr443.1-win64.zip`** from [Latest](https://github.com/no6969el/GEVR/releases/latest) / [vr443.1](https://github.com/no6969el/GEVR/releases/tag/vr443.1).
...
- **Troubleshooting only:** run **`Clear-GEVR-cache.bat`** from the vr443.1 zip (type **YES**) to wipe **`%LOCALAPPDATA%\\GEVR\\cache`** only (keeps saves). The tag notes say: if the picture still looks wrong, delete `%LOCALAPPDATA%\\GEVR` and run the bat again (that also drops saves).
