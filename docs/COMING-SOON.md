...
**Play now:** [GEVR Beta vr434](https://github.com/no6969el/GEVR/releases/tag/vr434) — full zip (exe + DLLs + `Start-GEVR.bat` + notes). Bring your own USA GoldenEye `.z64`.
...
Full recipe + controls: [CONTROLS.md](CONTROLS.md). Attract sheet: [FEATURES.md](../FEATURES.md).
