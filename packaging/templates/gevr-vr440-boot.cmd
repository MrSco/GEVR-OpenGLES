@echo off
rem GEVR Beta vr440 boot. Same KEEP stack as the vr434 quality zip, then ROM starter.
...
rem A/X = N64 A (confirm / select in pause). GETV_XR_BTN_A=use restores doors/reload on A.
